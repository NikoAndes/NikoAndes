...
<a href="https://github.com/NikoAndes">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=58A6FF&center=true&vCenter=true&width=700&lines=Engineering+student+%40+UMNG+%F0%9F%8E%93;Java+OOP+%7C+Data+Structures+%7C+Algorithms;ESP32+%7C+Arduino+%7C+IoT+Sensors;Building+real+hardware+%2B+software+systems;Open+to+internships+%26+collaborations" alt="Typing" />
</a>
...
| [🔬 **mechatronics-lab-portfolio**](https://github.com/NikoAndes/mechatronics-lab-portfolio) | Academic portfolio of embedded systems, PCB design & BLDC motor control | `C++` `ESP32` `KiCad` | Active |
| [📡 **esp32-iot-sensor-dashboard**](https://github.com/NikoAndes/esp32-iot-sensor-dashboard) | ESP32 firmware + real-time Canvas.js web dashboard for sensor monitoring | `C++` `JavaScript` `Canvas API` | Active |
...
| Skill | Progress |
|:------|:---------|
| Java OOP & Algorithms | ███████▌ `75%` |
| ESP32 / Embedded C++ | ██████░░ `65%` |
| Web Frontend (HTML/CSS/JS) | █████░░░ `55%` |
| Spring Boot / REST APIs | ██░░░░░░ `20%` |
| React / Vue.js | █░░░░░░░ `10%` |
